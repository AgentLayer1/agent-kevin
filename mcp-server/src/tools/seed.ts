  ...
  defineTool({
    ...
    inputSchema: {
      ...
      extras: z
        ...
        .optional()
        .describe('Skill-authored bundle content, e.g. [{path: "AGENTS.md", content: <curated overlay>}].'),
      permissions: z
