...
```json
{
  ...
  "permissions": {
    ...
    "allow": [
      ...
      "Skill(agent-kevin:pr-adversarial)",
      "Skill(agent-kevin:pr-review)",
      "Skill(agent-kevin:pr-walkthrough)",
