...
**Apply when:** product, UX, API-shape, or scope tradeoffs come up.
...
[Foundational thinking](foundational-thinking.md) governs the order of the work. This principle governs the target.

---

Adapted from [pstack](https://github.com/cursor/plugins/tree/main/pstack) `principle-experience-first` (MIT, Copyright (c) 2026 Lauren Tan).
