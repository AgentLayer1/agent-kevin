...
> - ☐ GitHub — read-only PR + GitHub Actions access (`github_pr_*`, `github_run_*`) so Kevin can review PRs and walk their own (the `pr-review` and `pr-walkthrough` skills) and diagnose failing CI builds
