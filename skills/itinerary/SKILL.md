...
name: itinerary
description: >
  Plan a trip end-to-end and generate a polished, interactive, print-ready HTML itinerary. Use
  whenever the user wants to plan a vacation, family trip, day trip, road trip, or weekend getaway,
  asks for an itinerary, or wants help organizing travel dates, flights, routes, or hotels, even if
